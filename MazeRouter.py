...
def HeuristicF(sourcePoint,
               targetPoint):  # the heuristic function calculates the manhattan ditance + the cost of vias between the layers (the cost of the path between current and target nodes)
